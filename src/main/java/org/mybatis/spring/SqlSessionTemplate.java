 ...
 * SqlSession操作模板实现类,代码和org.apache.ibatis.session.SqlSessionManager相似
 *
 * 和事务相关的方法不允许 sqlSessionProxy 调用
 */
public class SqlSessionTemplate implements SqlSession, DisposableBean {
  ...
  public SqlSessionTemplate(SqlSessionFactory sqlSessionFactory, ExecutorType executorType,
    ...
    // <1> 创建 sqlSessionProxy 对象 使用的方法拦截器是 SqlSessionInterceptor 类
   ...
   * SqlSessionTemplate的内部类,实现InvocationHandler接口,将SqlSession的操作,路由到Spring托管的事务管理器中
   */
