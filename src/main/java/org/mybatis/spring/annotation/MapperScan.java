 ...
 * 从而实现创建 Mapper 对象,可以基于 org.mybatis.spring.sample.SampleEnableTest 单元测试
 *
 * @Import 注解，负责资源的导入。如果导入的是一个 Java 类，例如此处为 MapperScannerRegistrar 类，
 * Spring 会将其注册成一个 Bean 对象。而 MapperScannerRegistrar 类呢
 */
